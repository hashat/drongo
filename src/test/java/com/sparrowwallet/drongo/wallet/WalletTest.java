...
public class WalletTest {
    ...
    public void p2pkhDerivationTest() throws MnemonicException {
        ...
        Assert.assertEquals("12kTQjuWDp7Uu6PwY6CsS1KLTt3d1DBHZa", wallet.getAddress(new KeyPurpose(0), 0).toString());
        Assert.assertEquals("1HbQwQCitHQxVtP39isXmUdHx7hQCZovrK", wallet.getAddress(new KeyPurpose(0), 1).toString());
    }
    ...
    public void p2shP2wpkhDerivationTest() throws MnemonicException {
        ...
        Assert.assertEquals("3NZLE4TntsjtcZ5MbrfxwtYo9meBVybVQj", wallet.getAddress(new KeyPurpose(0), 0).toString());
        Assert.assertEquals("32YBBuRsp8XTeLx4T6BmD2L4nANGaNDkSg", wallet.getAddress(new KeyPurpose(0), 1).toString());
    }
    ...
    public void p2wpkhDerivationTest() throws MnemonicException {
        ...
        Assert.assertEquals("bc1quvxdut936uswuxwxrk6nvjmgwxh463r0fjwn55", wallet.getAddress(new KeyPurpose(0), 0).toString());
        Assert.assertEquals("bc1q95j2862dz7mqpraw6qdjc70gumyu5z7adgq9x9", wallet.getAddress(new KeyPurpose(0), 1).toString());
    }
    ...
    public void p2shDerivationTest() throws MnemonicException {
        ...
        Assert.assertEquals("38kq6yz4VcYymTExQPY3gppbz38mtPLveK", wallet.getAddress(new KeyPurpose(0), 0).toString());
        Assert.assertEquals("3EdKaNsnjBTBggWcSMRyVju6GbHWy68mAH", wallet.getAddress(new KeyPurpose(1), 1).toString());
    }
    ...
    public void p2shP2wshDerivationTest() throws MnemonicException {
        ...
        Assert.assertEquals("3Mw8xqAHh8g3eBvh7q1UEUmoexqdXDK9Tf", wallet.getAddress(new KeyPurpose(0), 0).toString());
        Assert.assertEquals("35dFo1ivJ8jyHpyf42MWvnYf5LBU8Siren", wallet.getAddress(new KeyPurpose(1), 1).toString());
    }
    ...
    public void p2wshDerivationTest() throws MnemonicException {
        ...
        Assert.assertEquals("bc1q20e4vm656h5lvmngz9ztz6hjzftvh39yzngqhuqzk8qzj7tqnzaqgclrwc", wallet.getAddress(new KeyPurpose(0), 0).toString());
        Assert.assertEquals("bc1q2epdx7dplwaas2jucfrzmxm8350rqh68hs6vqreysku80ye44mfqla85f2", wallet.getAddress(new KeyPurpose(1), 1).toString());
    }
    ...
    public void testHighDerivationPath() {
        ...
        Assert.assertEquals("bc1qarzeu6ncapyvjzdeayjq8vnzp6uvcn4eaeuuqq", wallet.getAddress(new KeyPurpose(0), 0).toString());
    }
}
